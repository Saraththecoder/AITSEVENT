...
export const AdminDashboard: React.FC<AdminDashboardProps> = ({
  ...
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 space-y-6 font-data text-xs">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 bg-[#111115] p-5 border border-[#22222a] shadow-xl">
        ...
        <div className="flex items-center space-x-2">
          <button
            ...
            className="px-4 py-2.5 bg-[#00D2BE] hover:bg-[#00b5a3] text-[#08080A] font-display text-xs font-bold flex items-center space-x-2 shadow-lg transition-all"
          >
